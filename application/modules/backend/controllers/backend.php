...
class Backend extends MX_Controller
{
	...
	function users()
	{
		...
		$this->template->set_template('adm');
      	$this->template->write_view('conteudo','backend/users', $data); //posso carregar o conteúdo de uma view aqui
	...
	{		
		...
		$this->template->set_template('adm');
      	$this->template->write_view('conteudo','backend/roles', $data); //posso carregar o conteúdo de uma view aqui
      	$this->template->render();
	...
	function uri_permissions()
	{
		...
		$this->template->set_template('adm');
      	$this->template->write_view('conteudo','backend/uri_permissions', $data); //posso carregar o conteúdo de uma view aqui
      	$this->template->render();
	...
	function custom_permissions()
	{
		...
		$this->template->set_template('adm');
      	$this->template->write_view('conteudo','backend/custom_permissions', $data); //posso carregar o conteúdo de uma view aqui
      	$this->template->render();
