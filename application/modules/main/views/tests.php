...
<html lang="en">
	...
	<div id="container">
		...
		<p><strong>Has role 'admin':</strong> <u><?php echo $this->perm->has_role('admin') ? 'True' : 'False'; ?></u> => should be 'true'</p>
			<p><strong>Has role 'admin':</strong> <u><?php echo $this->perm->has_role('admin') ? 'True' : 'False'; ?></u> => should be 'true'</p>
		<!--<p><strong>Has roles 'users' and 'admin':</strong> <u><?php// echo $this->perm->has_role(array('usuario', 'admin')) ? 'True' : 'False'; ?></u> => should be 'true'</p>
		...
		<h2>Groups</h2>
		<p><strong>In group 'admin':</strong> <u><?php echo $this->perm->in_group('admin') ? 'True' : 'False'; ?></u></p>
		<p><strong>In group 'Usuario':</strong> <u><?php echo $this->perm->in_group('usuario') ? 'True' : 'False'; ?></u></p>
		<p><strong>In group '1':</strong> <u><?php echo $this->perm->in_group(1) ? 'True' : 'False'; ?></u></p>
		<p><strong>In group '3':</strong> <u><?php echo $this->perm->in_group(3) ? 'True' : 'False'; ?></u></p>
	</div>
	</body>
</html>